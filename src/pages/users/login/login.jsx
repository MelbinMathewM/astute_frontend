        ...
        if (validateForm()) {
            ...
            try {
                ...
                if (response.status === 200) {
                    ...
                    Cookies.set('refreshToken',resData.refreshToken);
                    dispatch(setUserToken(resData.accessToken));
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
                ...
                <p className="mt-2">Don't have an account? <Link to='/register' className="text-blue-400 hover:text-blue-700">Register here!</Link></p>
            </div>
        </div>
    );
};
